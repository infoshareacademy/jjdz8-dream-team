...
public class StandardDeviation {
    ...
    public void StataProgram(double arr5[], Teacher teacher) throws IOException {
        ...
        switch (levelString) {
            ...
            case 3:
                StandardDeviation.max(arr5);
            {
                System.out.println("Najwyzsza wystawiona ocena" + max(arr5));

            }
            case 4:
                StandardDeviation.median(arr5);
            {
            ...
            case 5:
                StandardDeviation.mode(arr5);
            {
                System.out.println("ocena występująca najczęściej " + calculateMode(arr5));
            }
            case 6:
                StandardDeviation.skew(arr5);
            {
                if (skew(arr5) == 0) {
                    System.out.println("rozklad symetryczny.Wszystkie osoby ocenialy wykladowce podobnie");
                    break;
                }
                if (skew(arr5) < 0) {
                    System.out.println("rozkład ocen lewoskośny,Osoby oceniały wykładowce wysoko");
                    break;
                }
                if (skew(arr5) > 0) System.out.println("Rozkład ocen prawoskośny.Osoby oceniły wykładowcę nisko");
            }
            case 7:
                StandardDeviation.stddev(arr5);
            {
                if (stddev(arr5) < 4.08) {
