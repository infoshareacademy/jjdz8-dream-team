...
import com.infoshareacademy.service.StudentsEditService;
...
public class StudentAccountEditorServlet extends HttpServlet {

    @Inject
    private TemplateProvider provider;

    @Inject
    private StudentsEditService editService;
    ...
    protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        ...
        Template template = provider.getTemplate(getServletContext(), "student-account-data-after-edit.ftlh");
    ...
    protected void doPost(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        ...
        if (session.getAttribute(EMPTY_NICKNAME)!=null || session.getAttribute(EMPTY_EMAIL) !=null
            ...
            resp.sendRedirect("/edit-student-account");
            return;
        }
    ...
    private void processPostRequest(HttpServletRequest req, User user)  throws ServletException, IOException {
        ...
        if (!PasswordResolver.isCorrectPasswordFormat(password) || isIncorrectCorrectParameter(password)) {
            ...
            editService.editPassword(user, password);
        }
    }
